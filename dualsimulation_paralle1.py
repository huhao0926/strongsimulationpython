...
class DualWorker:
    ...
    #    global Qgraph
    #    global Dgraph
        for row in xrange(0, Dgraph.num_vertices()):
            self.sim_counter_post[row] = [0 for col in xrange(0, Qgraph.num_vertices())]
            self.sim_counter_pre[row] = [0 for ccl in xrange(0, Qgraph.num_vertices())]
